...
- [ ] **Real-time свечи через WebSocket**
  - [ ] Подписка на kline (свечи) через WebSocket (сейчас только тикеры)
  - [ ] Автоматическое обновление OHLCV в TimescaleDB при закрытии свечи
...
- [ ] **Расширенный анализ**
  ...
  - [ ] Dynamic confidence weights (калибровка весов на основе backtesting)
  - [ ] Multi-timeframe confluence (объединение сигналов с нескольких ТФ)
